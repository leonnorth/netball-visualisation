function rivalries(){
	...
	function clearPane(){
		...
		// d3.select("#content").selectAll("g")
		svgContainer.selectAll(".pic").on("mouseover", null);
		svgContainer.selectAll(".pic").on("mouseout", null);
	...
	var tempData = {"nodes":[
		...
		{"name":winner, "top":wincol, "bot":wincol, "win":winner, "los":winner, "id":3},
...
// gradient.remove();
	...
	leftover_icons.on("mouseover", function(d){console.log("fuck")}).on("mouseout", null);
